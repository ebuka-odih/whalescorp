...
{{--                                                        <button class="btn red">Withdraw</button>--}}
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h5 class="card-title">Make Deposit</h5>
                                                        <div class="row wallet-address">
                                                            <div class="col-md-12">
                                                                <p style="font-size: 18px" class="text-danger">Note: to make a deposit select a payment method you will like to pay into and enter the amount you want to deposit.
                                                                </p>
                                                                <br>
                                                                <hr>
                                                                <form action="{{ route('user.processDeposit') }}" method="POST">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <select name="payment_method_id" id="" class="form-control form-control-lg">
